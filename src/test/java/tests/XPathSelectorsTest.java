...
public class XPathSelectorsTest {
    ...
    public void xpathLocatorsTest() {
        driver.get("D:\\Tasks_IT_Academy\\GitHubRepos\\TAF_AQA18\\TAF_AQA18\\src\\test\\resources\\index.html");

        // Абсолютный xpath
        Assert.assertTrue(driver.findElement(By.xpath("/html/body/div/div/div/div[2]/ul/li[1]/span[1]")).isDisplayed());
    ...
    public void xpathAxesTest() {
        driver.get("file:/Users/aleksandr/Documents/Work/TechMeSkills/code/TAF_AQA18_onl/TAF_AQA18_onl/src/test/resources/index.html");
